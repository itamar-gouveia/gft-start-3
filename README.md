...
<p>Ao final deste projeto, o Dev irá conhecer os principais conceitos de mapeamento objeto relacional (ORM) usando o 
<strong>Spring Data JPA</strong>. Para isso, uma <strong>API REST</strong> será desenvolvida com ênfase na 
modelagem de suas entidades, em uma api de gerenciamento de empréstimos.</p>
